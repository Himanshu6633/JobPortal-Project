...
const EditJob = () => {
  ...
  useEffect(() => {
    const fetchJobById = async () => {
      try {
        const res = await axios.get(`${JOB_API_ENDPOINT}/getJob/${id}`, { withCredentials: true });
  ...
  const submitHandler = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await axios.put(`${JOB_API_ENDPOINT}/edit/${id}`, input, { withCredentials: true })
      if (res.data.success) {
